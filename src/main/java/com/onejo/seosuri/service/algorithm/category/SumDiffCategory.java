...
public class SumDiffCategory extends Category {

    @Override
    public String createContent(boolean isCorrectNumSentence, int name_var_index1, int name_var_index2,
    ...
    @Override
    public String createExplanation(String content, int name_var_index1, int name_var_index2,
